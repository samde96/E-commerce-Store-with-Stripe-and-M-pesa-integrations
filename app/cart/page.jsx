                ...
                {Object.keys(cartItems).map((itemId) => {
                  ...
                  return (
                    <tr key={itemId}>
                      ...
                      <td className="py-4 md:px-4 px-1 text-gray-600">Ksh.{formatPrice(product.offerPrice)}</td>
                      <td className="py-4 md:px-4 px-1">
                        ...
                        {/*.toFixed(2) to add decimals*/}
                      </td>
                      <td className="py-4 md:px-4 px-1 text-gray-600">Ksh.{formatPrice(product.offerPrice * cartItems[itemId])}</td>
                    </tr>
                  );
                })}
              </tbody>
